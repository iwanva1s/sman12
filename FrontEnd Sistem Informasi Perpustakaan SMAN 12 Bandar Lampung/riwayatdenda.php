...
$queryRiwayatdenda = "SELECT * FROM riwayat_denda";
        ...
        <table style="position: absolute;
            ...
            <thead>
                <tr>
                    ...
                    <td style="text-align: center; padding: 10px;">Total Terlambat</td>
                </tr>
            </thead>
            <tbody>
                <?php
...
while ($rowRiwayatdenda = mysqli_fetch_assoc($resultRiwayatdenda)) {
    ...
    echo "<td style='text-align: center;'>{$rowRiwayatdenda['total_denda']}</td>";
    echo "<td style='text-align: center;'>{$rowRiwayatdenda['total_terlambat']}</td>";
